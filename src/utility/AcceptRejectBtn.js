    ...
    <div className="flex text-sm items-center justify-between">
      {loading ? (
        ...
        (orderState === "accepted" && (
          <>
            <button
              onClick={() => handleRocket(rocketValue)}
              className="flex align-middle focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-3 py-1.5 mb-2 dark:bg-green-600 dark:hover:bg-green-700 mr-3"
            >
              Rocket
              <svg fill="#000000" width="16px" height="16px" viewBox="-6 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <button
              onClick={() => handleOrderEdit("decline")}
              className="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-3 py-1.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 "
            >
              Decline
            </button>
          </>
        ...
        (orderState === "new" && (
          <>
            <button
              onClick={() => handleOrderEdit("accepted")}
              className="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-3 py-1.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 mr-3"
            >
              Accept
            </button>
            <button
