      ...
      <div ref={searchBar}>
        <div className="mx-auto relative">
          ...
          <input
            ...
            onFocus={handleFocus}
            onBlur={handleBlur}
            className="input w-full rounded-lg px-8 py-1 border-2 border-transparent focus:outline-none focus:border-blue-500 placeholder-gray-400 transition-all duration-300 shadow-md"
            placeholder="Search..."
            required=""
            type="text"
          />
        ...
        <div
          style={{ display: searchDispaly }}
          className="transition ease-in-out delay-150 absolute z-50 w-full sm:w-auto sm:mx-auto  sm:pr-0 pr-4 mx-auto disableTouchSelect"
        >
          {loading ? (
