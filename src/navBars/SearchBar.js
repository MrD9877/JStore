        ...
        <>
            <div ref={searchBarDiv} className='w-screen searchBarDiv px-px'>
                <div ref={searchBar} className='flex justify-between searchBar px-3 border rounded-xl'>
                    ...
                    <input onClick={handleFocus} onFocus={handleFocus} onBlur={handleOffFocus} type='text' className='searchBarInput focus:border-blue-500' placeholder="jeens,T-shirt,Men's cloths..." />
