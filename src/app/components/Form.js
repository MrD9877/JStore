...
export default function Form({ onSubmit, style, loading }) {
  ...
  return (
    <>
      <div>
        <form className=" px-12 pb-1 " onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
        ...
        <div className="w-4/5 mx-auto text-white">
          <div className="flex mx-auto items-center justify-center my-4">
            <hr className="w-24 h-1 my-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-700" />
            <span className="mx-2">or</span>
            <hr className="w-24 h-1 my-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-700" />
          </div>
          <Link href={`${process.env.SERVER_URL}/googleauth`}>
