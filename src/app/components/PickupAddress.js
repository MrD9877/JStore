            ...
            <div class="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
                <div class="w-full flex flex-col 2xl:w-1/3">
                    <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                        <h4 class="text-xl text-gray-900 font-bold">ShipRocket Pickup </h4>
                        {pickup ? (pickup.map((item) => {
                            return <ul class="mt-2 text-gray-700">
                                <li class="flex border-y py-2">
                                    <span class="font-bold w-24">Pickup Location:</span>
                                    <span class="text-gray-700">{item.pickup_location}</span>
                                </li>
                                <li class="flex border-y py-2">
