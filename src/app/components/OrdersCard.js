        ...
        <>
            <div className='flex flex-wrap'>
                {array ? array.map((item) => {
                    ...
                    return <div key={item.orderId} className="relative flex sm:mx-3 mx-auto h-full w-60 sm:max-h-80 overflow-scroll my-3 bg-white shadow-sm border border-slate-200 rounded-lg sm:flex-col">
                                    ...
                                    <div className="flow-root">
                                        <ul role="list" className="divide-y divide-gray-200 ">
                                            {item.products.map((product) => {
                                                return <li key={product._id} className="py-1 ">
