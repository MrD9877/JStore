    ...
    return (
        <>
            <div className='w-full lg:ml-8'>
                ...
                <div className='mx-4 m-auto lg:mx-auto'>
                    <div className="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
                        <div className="w-full flex flex-col ">
                            <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                                ...
                                <ul className="mt-2 text-gray-700 overflow-hidden">
                                    <li className="flex justify-between border-y py-2">
                                        ...
                                        <span className="text-gray-700 mr-28 flex-wrap "> {customer && customer.deliveryaddress.state}</span>
                                    </li>
                                    <li className="flex justify-between border-b py-2">
                                        <div className="flex">
                                            <span className="font-bold w-24">
                                        ...
                                        <span className="text-gray-700 mr-28 flex-wrap"> {customer && customer.deliveryaddress.pin}</span>
                                    </li>
                                    <li className="flex justify-between border-b py-2">
                                        <div className="flex">
                                            <span className="font-bold w-24">
                                        ...
                                        <span className="text-gray-700 mr-28 flex-wrap"> {customer && customer.deliveryaddress.city}</span>
                                    </li>
                                    <li className="flex justify-between border-b py-2">
                                        <div className="flex">
                                            <span className="font-bold w-24">
                                        ...
                                        <span className="text-gray-700 mr-28 flex-wrap">
                                            <p>
                                                {customer && customer.deliveryaddress.streetname},
                                            </p>
                                            <p>
                                                {customer && customer.deliveryaddress.housenumber}
                                            </p>
                                        </span>
                                    </li>
                                </ul>
