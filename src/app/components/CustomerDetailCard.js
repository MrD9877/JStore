    ...
    return (
        <>
                        ...
                        <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <li className="py-3 sm:py-4">
                                <div className="flex items-center">
                                    ...
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                        {customer && customer.email ? customer.email : "NOT Provided"}
                                    </div>
                                </div>
                            </li>
                            <li className="py-3 sm:py-4">
            ...
            <div className='p-4'>
                <div className="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <div className="flex items-center justify-between mb-4">
                        <h5 className="text-xl font-bold leading-none text-gray-900 dark:text-white">Deliver Address</h5>
                    </div>
                    <div className="flow-root">
                        <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
                            <li className="py-3 sm:py-4">
                                <div className="flex items-center">
                                    ...
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                        {customer && customer.deliveryaddress.state}
                            ...
                            <li className="py-3 sm:py-4">
                                <div className="flex items-center">
                                    ...
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                        {customer && customer.deliveryaddress.pin}
                                    </div>
                                </div>
                            </li>
                            <li className="py-3 sm:py-4">
                                <div className="flex items-center">
                                    ...
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                        {customer && customer.deliveryaddress.city}
                                    </div>
                                </div>
                            </li>
                            <li className="py-3 sm:py-4">
