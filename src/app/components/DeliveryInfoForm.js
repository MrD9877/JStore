  ...
  return (
    <div>
      ...
      <div className="p-8 md:mt-5 lg:mt-10 h-fit lg:w-lg lg:mx-auto">
        <div class="duration-500 group overflow-hidden relative rounded bg-neutral-800 text-neutral-50 p-4 flex flex-col justify-evenly">
          ...
          <div class="z-10 flex flex-col justify-evenly w-full h-full">
            <span class="text-2xl font-bold">Delivery Details</span>
