...
export default function page() {
    ...
    const submit = async () => {
        ...
        try {
            const res = await fetch(`${process.env.SERVER_URL}/avatar`, { method: "POST", credentials: "include", body: formData })
    ...
    return (
        <div className="w-full">
            ...
            <form style={{ maxWidth: "650px" }} className="p-8 mx-auto" onSubmit={handleSubmit(submit)}>
                <div
                    className="w-fit mx-auto mb-5 bg-purple-600 text-white font-medium py-2 px-4 rounded-lg shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                    Images: {file.length}
                </div>
