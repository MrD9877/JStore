...
export default function page() {
    ...
    return (
        <div>
            ...
            <div className='px-0.5 mx-auto sm:mx-10'>
                        ...
                        <div className="bg-gray-800 rounded-lg shadow-xl p-8">
                            ...
                            <ul className="mt-2 text-white">
                                ...
                                <li className="flex border-b py-2 overflow-scroll">
                                    ...
                                    <span className="text-white ml-2 sm:ml-10"> {user && user.deliveryaddress.housenumber}  {user && user.deliveryaddress.streetname}  {user && user.deliveryaddress.city}</span>
                                </li>
                                <li className="flex border-b py-2">
