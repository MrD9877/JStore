...
export default function page() {
    ...
    return (
        <div>
            ...
            <div className='mx-10'>
                <div className="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
                    <div className="w-full flex flex-col 2xl:w-1/3">
                        <div className="flex-1 bg-gray-800 rounded-lg shadow-xl p-8">
                            ...
                            <ul className="mt-2 text-white">
                                ...
                                <li className="flex border-b py-2">
                                    ...
                                    <span className="text-white">{user && user.phonenumber}</span>
                                </li>
                                <li className="flex border-b py-2">
                                    <span className="font-bold w-24">Email:</span>
                                    <span className="text-white">{user && user.email ? user.email : "Not provided"}</span>
                                </li>
                                <li className="flex border-b py-2">
                                ...
                                <li className="flex border-b py-2">
                                    ...
                                    <span className="text-white"> {user && user.deliveryaddress.state}</span>
                                </li>
                                <li className="flex border-b py-2">
                                    <span className="font-bold w-24">Location:</span>
                                    <span className="text-white"> {user && user.deliveryaddress.housenumber},{user && user.deliveryaddress.streetname},{user && user.deliveryaddress.city}</span>
                                </li>
                                <li className="flex border-b py-2">
                                    <span className="font-bold w-24">PIN:</span>
                                    <span className="text-white"> {user && user.deliveryaddress.pin}</span>
                                </li>
                                <li className="flex border-b py-2">
                            ...
                            <Link href={"/profile/delivery"}>
                                <button class="flex items-center mt-4 bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
            ...
            <div className='mb-20'>
                {user && <DisplayOrderSummary user={user} />}
            </div>
        </div>
    )
}
