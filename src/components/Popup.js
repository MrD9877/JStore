...
export default function Popup({ msg = "somthing went wrong!!Go to home page", link = "/", heading = "New notification" }) {
    ...
    <>
      <div style={{ display }} className="w-screen h-[70vh] flex justify-center align-middle fixed z-20 items-center ">
        <div
          ...
          className="shadow-grayesh mx-auto w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg  dark:bg-gray-800 dark:text-gray-300"
          role="alert"
        >
