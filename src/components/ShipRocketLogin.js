      ...
      <div className="my-4 flex flex-col">
        <div className="w-full flex flex-col">
          <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
            ...
            {loading ? (
              <Loading height="40px" width="100%" />
            ) : (
              <form className="mt-2 text-gray-700" onSubmit={handleSubmit(onSubmit)}>
                <li className="flex border-y py-2">
                  <label htmlFor="eamil" className="font-bold w-24">
                    Email:
                  </label>
                  <input {...register("email")} type="text" name="email" className="text-gray-700 border px-2 rounded-md" required />
                </li>
                <li className="flex py-2">
                  <label htmlFor="password" className="font-bold w-24">
                    password:
                  </label>
