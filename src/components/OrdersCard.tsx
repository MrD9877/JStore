...
export default function OrdersCard({ array }: { array: OrderType[] }) {
    ...
    <>
      <div className="flex flex-wrap">
        {array.length > 0 ? (
                      ...
                      <div className="flow-root">
                        <ul role="list" className="divide-y divide-gray-200 ">
                          {item.items.map((product) => {
                            return (
                              <li key={product.productId} className="py-1 ">
                                <div className="flex justify-between items-center">
                                  <div className="flex mr-2 text-sm  justify-center align-middle ">
                                    <p className="text-red-500 flex align-middle justify-center">{product.variant.quantity}*</p>
          ...
          <div className="w-full h-[30%] flex justify-center items-center">No Orders</div>
        )}
      </div>
    </>
  );
