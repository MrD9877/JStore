          ...
          <div className="mb-2">
            ...
            <div ref={passwordInput} className="flex justify-evenly  pr-2.5 rounded-lg">
              <input
                ...
                {...register("password")}
                required
                className="shadow-sm text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 shadow-sm-light"
              />
