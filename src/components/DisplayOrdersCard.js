        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-8">
          ...
          {loading ? (
            ...
            orders.map((order) => {
              ...
              return (
                <div key={order._id} className="flex flex-wrap items-center gap-y-4 border-b border-gray-200 py-4 dark:border-gray-700 md:pb-5">
                  {/* order id  */}
                  <dl className="w-1/2 sm:w-48">
                    ...
                    <dd className="mt-1.5 flex align-middle text-base font-semibold text-gray-900 dark:text-white">
                      <span onClick={() => CopytoClip(order.orderId, popTost)} className="hover:underline">
